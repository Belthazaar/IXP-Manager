...
/**
 * Constructs a new add link dialog.
 */
var AddLinkDialog = function(editorUi, cell, btnLabel, graph)
{
	var model = graph.getModel();
	var div = document.createElement('div');
	mxUtils.write(div, 'Add link between switches:');
	...
	var edges = model.getConnections(cell);
	...
	for (edge of edges){
		...
		console.log(edge.value.attributes)
		console.log(cell.value.attributes.switch)
		var sw_name = cell.value.attributes.switch.value;
		console.log(edge.value.attributes[sw_name])
		// var swLink = document.createElement('input')
		// swLink.setAttribute('value', edge.value.attributes[sw_name].value)

	}

	var ifaces = cell.value.firstChild.children;

	for (var i = 0; i <= ifaces.length; i++)
	{
		//TODO: Add interface names to the dialog box
	}
